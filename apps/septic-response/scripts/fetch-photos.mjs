...
const SLOTS = {
  "hero.jpg": { query: "clean suburban home green lawn", orientation: "portrait" },
  "canopy.jpg": { query: "green grass lawn sunlight", orientation: "landscape" },
  "v2-hero.jpg": { query: "modern suburban house exterior yard", orientation: "landscape" },
};
